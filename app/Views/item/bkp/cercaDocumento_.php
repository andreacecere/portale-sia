                    ...
                    <form method='POST'>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-sm-3">
                                ...
                                <input type='text' class='form-control' name='id_operazione'>
                            </div>
                            <div class="form-group col-sm-3">
                        ...
                        <button type="button" id="submitForm" class="btn btn-primary btnCerca">Cerca</button>
                    </form>
                </div>
            </div>
            <div class='esitoVisualizza'>
