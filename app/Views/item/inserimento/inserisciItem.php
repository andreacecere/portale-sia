                    ...
                    <div class='container-fluid'>
                        <div class='row'>
                            <div class='col-md-6'>
                                ...
                                <input type='text' class='form-control form-control-sm seriale' maxlength="20" required>
                                ...
                                <select class='form-control form-control-sm select2bs4 stato'>
                                    <?php 
                                        for($i=0; $i<count($stato); $i++){
                                            if ( strtolower($stato[$i]['descrizione']) == "disponibile" )
