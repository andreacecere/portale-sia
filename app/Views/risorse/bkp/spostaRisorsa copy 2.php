                    ...
                    <form method="post" class="" action="">
                        <div class="form-row">
                            <div class="form-group col-md-4" id="tipo_select">
                                <label for="tipo_articolo" id="tipo_articolo_label">Risorsa</label>
                            ...
                            <div class="form-group col-md-4" id="condizione_select">
                                <label for="condizione_articolo" id="condizione_articolo_label">Commessa</label>
                            ...
                            <div class="form-group col-md-4" id="fornitore_select">
                                <label for="fornitore_articolo" id="fornitore_articolo_label">Sede</label>
