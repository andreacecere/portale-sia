...
<!--<script type="text/javascript" src="<?php base_url() ?>/assets/plugins/jquery/jquery.min.js"></script>-->
<!-- Bootstrap 4 -->
    ...
    $(function() {
        $(document).ready(function() {
            ...
            $('#tipo_articolo').change(function() {
                var idTipoArticolo = $(this).val();
                alert(url);
                $.ajax({
                    //url: "<php echo site_url('product/get_sub_category'); ?>",
                    //url: "magazzino.local/Articolo/getListaArticoli/" + idTipoArticolo,
                    url: "Articolo/getCondizioniArticolo/",
                    method: "POST",
                    data: {
                        idTipoArticolo: idTipoArticolo
                    },
                    async: true,
                    dataType: 'json',
